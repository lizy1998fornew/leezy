    ...
    methods (Access = private)
        function onConnectSet_libreVNA(app)
            ...
            try
                ...
                app.vna.cmd(sprintf(':VNA:STIM:LVL %.15g', power));
        ...
        function onSave(app)
            if isempty(app.allS21) && isempty(app.S21b)
            ...
            if isempty(app.S21b)
                ...
                if numel(app.S21b) == npts
                    ...
                    try
                        bg_interp = interp1(app.refFreq, app.S21b, freqs, 'linear', 'extrap');
